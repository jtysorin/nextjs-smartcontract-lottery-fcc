...
```
git clone https://github.com/jtysorin/nextjs-smartcontract-lottery-fcc
...
> You can read more about how to use that repo from its [README.md](https://github.com/jtysorin/hardhat-smartcontract-lottery-fcc/blob/master/README.md)
